...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        New Update Email Id's
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">NewUpdates</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <?php
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <td>".$column1Value."</td>
                        <td>".$column2Value."</td>
                        <td><a href=mailto:".$column2Value."><i class='fa fa-paper-plane'></i> Send</a></td>
                        </tr>
