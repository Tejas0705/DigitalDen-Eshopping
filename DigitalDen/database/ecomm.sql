...
(4, 'Pujari  Tejas Raghu', 'tejupujari2001@gmail.com', 'This is a nice page to buy desktop pc\'s and tablets!!!!');
...
--
-- Table structure for table `newupdates`
--

CREATE TABLE `newupdates` (
  `id` bigint(100) NOT NULL,
  `emailid` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `newupdates`
--

INSERT INTO `newupdates` (`id`, `emailid`) VALUES
(1, 'tejupujari2001@gmail.com'),
(2, 'shashankcoorg13@gmail.com'),
(3, 'tejaspoojary2001@gmail.com'),
(4, 'amoghrao20@gmail.com');
...
(11, 9, 'pay_NUqRom6fv9Einn', '2024-01-30'),
(12, 9, 'pay_NUqTU97atKBXlS', '2024-01-30'),
(13, 9, 'pay_NUqZpx66xqCsHB', '2024-01-30'),
(14, 9, 'pay_NUqbzLwiyTNM15', '2024-01-30'),
(15, 9, 'pay_NUqh13q9zbL8TC', '2024-01-30'),
(16, 9, 'pay_NUqiNlONGRu2yW', '2024-01-30'),
(17, 9, 'pay_NV5C2J3nBukIyu', '2024-01-31'),
(18, 9, 'pay_NX5eWfkYCJXHxj', '2024-02-05'),
(19, 9, 'pay_NXTZ3iRMDMzuUI', '2024-02-06'),
(20, 9, 'pay_NXYMLOKZvsSs0L', '2024-02-06'),
(21, 21, 'pay_NZq32o7j72FqGE', '2024-02-12');
...
--
-- Indexes for table `newupdates`
--
ALTER TABLE `newupdates`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `newupdates`
--
ALTER TABLE `newupdates`
